...
const handleCreateInvoice = async (e) => {
    ...
    if (billingType === 'appointment') {
        // Start with basic payload - NO items array
        payload = {
        ...
        // ONLY add items if there are products in cart (extra products)
        ...
        // If cartItems.length === 0, payload has NO items field at all
    ...
    const calculateSubtotal = () => {
        // For appointment billing, subtotal is only from additional products
                                ...
                                <form onSubmit={handleCreateInvoice}>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            {(billingType !== 'appointment' || (billingType === 'appointment' && cartItems.length >= 0)) && (
