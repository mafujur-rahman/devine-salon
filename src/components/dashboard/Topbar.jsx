      ...
      <div className="h-20 bg-black text-white border-b border-[#dba627]/20 flex items-center justify-between px-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 px-3 py-2 border border-[#dba627]/20 rounded-lg cursor-pointer hover:bg-[#dba627]/5 transition-all duration-300 bg-white/5">
            ...
            <span className="text-sm font-medium text-offwhite/80">April 2026</span>
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <div className="relative">
              <img
                src={userData?.avatar || "https://i.pravatar.cc/150?u=noah"} 
                alt={userData?.first_name || "Noah Arthur"}
            ...
            <div className="flex flex-col">
              <span className="text-sm font-bold text-white leading-tight">
                {userData ? `${userData.first_name} ${userData.last_name}` : "Noah Arthur"}
              </span>
              <span className="text-[11px] font-medium text-[#dba627] uppercase tracking-wider">Admin</span>
            </div>
