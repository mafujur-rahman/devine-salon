...
const roleMenus = {
    ...
    customer: [
        ...
        { name: "My Appointments", icon: MdCalendarToday, path: "/dashboard/user/appointments", hasSub: true },
        { name: "Booking History", icon: MdHistory, path: "/dashboard/user/history", hasSub: false },
        { name: "Favorite Stylists", icon: MdStar, path: "/dashboard/user/favorites", hasSub: false },
